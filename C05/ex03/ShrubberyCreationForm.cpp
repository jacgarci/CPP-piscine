...
ShrubberyCreationForm::ShrubberyCreationForm() : Form("shruberry creation", 145, 137), _target(std::string())
{

}

ShrubberyCreationForm::ShrubberyCreationForm(std::string const &target) : Form("shruberry creation", 145, 137), _target(target)
{
